...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOC, F06_Pin|F07_Pin|F01_Pin|F04_Pin);

    HAL_GPIO_DeInit(GPIOA, F03_Pin|F00_Pin);

    HAL_GPIO_DeInit(GPIOB, F05_Pin|F02_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, LCD_SCL_Pin|LCD_WR_RS_Pin|LCD_SDA_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PE5     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(ESC_Input_GPIO_Port, ESC_Input_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA0     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(Servo_Input_GPIO_Port, Servo_Input_Pin);
