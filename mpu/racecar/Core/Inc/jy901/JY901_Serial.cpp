...
uint16_t CJY901::getTime(const char* str) {
  ...
  if (strcmp(str, "millisecond") == 0)
    return JY901_data.time.millisecond;  // get millisecond
  return 0;
}  // getTime()
...
void CJY901::setCali(int caliFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_SETCALI, 5, 10);
  }
...
void CJY901::setDir(int dirFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_INSTALL, 5, 10);
  }
...
void CJY901::enterHiber() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_SLEEP, 5, 10);
  }
...
void CJY901::changeALG(int algFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_ALGAXIS, 5, 10);
  }
...
void CJY901::autoCaliGyro(int gyroFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_GYROAUTO, 5, 10);
  }
...
void CJY901::setAXoffset() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_AXOFF, 5, 10);
  }
...
void CJY901::setAYoffset() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_AYOFF, 5, 10);
	}
...
void CJY901::setAZoffset() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_AZOFF, 5, 10);
  }
...
void CJY901::setGXoffset() {
  ...
  if(_huart!=NULL){
  	  HAL_UART_Transmit(_huart, JY901_GXOFF, 5, 10);
    }
...
void CJY901::setGYoffset() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_GYOFF, 5, 10);
  }
...
void CJY901::setGZoffset() {
  ...
  if(_huart!=NULL){
  	  HAL_UART_Transmit(_huart, JY901_GZOFF, 5, 10);
    }
...
void CJY901::setHXoffset() {
  ...
  if(_huart!=NULL){
  	  HAL_UART_Transmit(_huart, JY901_HXOFF, 5, 10);
    }
...
void CJY901::setHYoffset() {
  ...
  if(_huart!=NULL){
    	  HAL_UART_Transmit(_huart, JY901_HYOFF, 5, 10);
      }
...
void CJY901::setHZoffset() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_HZOFF, 5, 10);
  }
...
void CJY901::setD0mode(int modeFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D0MODECONF, 5, 10);
  }
...
void CJY901::setD1mode(int modeFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D1MODECONF, 5, 10);
  }
...
void CJY901::setD2mode(int modeFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D2MODECONF, 5, 10);
  }
...
void CJY901::setD3mode(int modeFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D3MODECONF, 5, 10);
  }
...
void CJY901::setD0PWMH() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D0PWMHCONF, 5, 10);
  }
...
void CJY901::setD1PWMH() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D1PWMHCONF, 5, 10);
  }
...
void CJY901::setD2PWMH() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D2PWMHCONF, 5, 10);
  }
...
void CJY901::setD3PWMH() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D3PWMHCONF, 5, 10);
  }
...
void CJY901::setD0PWMT() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D0PWMTCONF, 5, 10);
  }
...
void CJY901::setD1PWMT() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D1PWMTCONF, 5, 10);
  }
...
void CJY901::setD2PWMT() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D2PWMTCONF, 5, 10);
  }
...
void CJY901::setD3PWMT() {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_D3PWMTCONF, 5, 10);
  }
...
void CJY901::setIICaddr(int addrFlag) {
  ...
  if(_huart!=NULL){
	  HAL_UART_Transmit(_huart, JY901_IICADDRESS, 5, 10);
  }
  //Serial1.write(JY901_IICADDRESS, 5);

}

void CJY901::turnLED(uint8_t ledFlag) {
	if(_huart!=NULL)return;
  JY901_LED[3] = ledFlag;
  //Serial1.write(JY901_LED, 5);
  HAL_UART_Transmit(_huart, JY901_LED, 5, 10);
